      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-4 md:px-6 mb-24">
        ...
        >
            ...
            <div className="relative z-10 flex flex-col items-center max-w-4xl mx-auto">
                <h2 className="text-4xl md:text-6xl lg:text-7xl font-display font-bold text-black uppercase tracking-tight mb-6">
                    Connect Engage Transform
                </h2>
                <p className="text-black/80 font-medium text-sm md:text-lg max-w-2xl mb-10 tracking-wide uppercase">
                ...
                <div className="flex flex-col md:flex-row items-center gap-4 w-full max-w-lg">
                    <div className="relative w-full">
                        <input 
                            ...
                            className="w-full bg-white text-black px-6 py-4 rounded-full outline-none focus:ring-4 focus:ring-black/20 transition-all font-medium placeholder:text-gray-400"
                        />
                    </div>
                    <button className="w-full md:w-auto bg-black text-white px-8 py-4 rounded-full font-bold uppercase tracking-wider hover:bg-gray-900 hover:scale-105 transition-all duration-300 whitespace-nowrap shadow-lg border border-transparent hover:border-white/20">
                        Join Now
                    </button>
                </div>
            </div>
      ...
      <div className="max-w-[1400px] mx-auto px-6 pb-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 items-start border-t border-white/10 pt-16">
            ...
            <div className="flex flex-col items-center justify-center">
                <h4 className="text-brand-red font-bold uppercase tracking-widest text-sm mb-6">Follow Us On</h4>
                ...
                <div className="flex gap-6 mb-8">
                    {[
                        ...
                        { name: 'Facebook', href: '#', icon: <Facebook className="w-6 h-6" /> },
                        {
                            name: 'TikTok',
                            href: '#',
                            icon: <img src={tiktokIcon} alt="" className="w-6 h-6" />
                        }
                    ].map(({ name, href, icon }) => (
                        <a
                            key={name}
                ...
                <ul className="flex flex-wrap justify-center gap-6 md:gap-8">
                    {[
                        ...
                        <li key={link.name}>
                            <Link href={link.href} className="text-gray-400 hover:text-brand-red text-sm font-bold uppercase tracking-wider transition-colors">
                                {link.name}
                            </Link>
                        </li>
                    ))}
            ...
            <div className="flex flex-col items-center md:items-end text-center md:text-right">
                <h4 className="text-brand-red font-bold uppercase tracking-widest text-sm mb-6">Contact</h4>
